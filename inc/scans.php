<div class="box" id="<?php echo html($FILE); ?>">
...
<a class="tool icon del" href="index.php?page=Scans&delete=Remove&file=<?php echo html($FILE); ?>" onclick="return delScan('<?php echo html($FILE); ?>')"><span class="tip">Delete</span></a>
